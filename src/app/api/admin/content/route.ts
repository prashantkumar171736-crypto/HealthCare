...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (collection === "posts") {
      ...
      doc.symptoms = Array.isArray(symptoms) ? symptoms : [];
      doc.causes = Array.isArray(causes) ? causes : [];
      doc.riskFactors = Array.isArray(riskFactors) ? riskFactors : [];
      doc.diagnosis = diagnosis || "";
      doc.treatmentOptions = Array.isArray(treatmentOptions) ? treatmentOptions : [];
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    if (collection === "posts") {
      ...
      updateDoc.symptoms = Array.isArray(symptoms) ? symptoms : [];
      updateDoc.causes = Array.isArray(causes) ? causes : [];
      updateDoc.riskFactors = Array.isArray(riskFactors) ? riskFactors : [];
      updateDoc.diagnosis = diagnosis || "";
      updateDoc.treatmentOptions = Array.isArray(treatmentOptions) ? treatmentOptions : [];
