                  ...
                  {ctxMenuOpen && (
                    ...
                    >
                      ...
                      <div className="ctx-row-bar">
                        ...
                        <button type="button" title="Text Color" className="ctx-btn-icon" onClick={() => { restoreSelection(); colorSelectionRef.current = savedSelectionRef.current; setPendingColor("#000000"); setColorPickerOpen("text"); setCtxMenuOpen(false); }}>
                          <span style={{ fontWeight: 900, borderBottom: "2px solid #000" }}>A</span>
                        </button>
                        <button type="button" title="Highlight Color" className="ctx-btn-icon" onClick={() => { restoreSelection(); colorSelectionRef.current = savedSelectionRef.current; setPendingColor("#ffff00"); setColorPickerOpen("highlight"); setCtxMenuOpen(false); }}>
                      ...
                      {/* Insertions */}
                      <button type="button" className="ctx-item" onClick={() => { handleInsertLink(); setCtxMenuOpen(false); }}>
                        <span className="ctx-item-left"><span>🔗</span> Insert Hyperlink...</span>
                      </button>
                      <button type="button" className="ctx-item" onClick={() => { restoreSelection(); mediaInsertRangeRef.current = savedSelectionRef.current; fileInputRef.current?.click(); setCtxMenuOpen(false); }}>
                        <span className="ctx-item-left"><span>🖼️</span> Insert Image</span>
                      </button>
                      <button type="button" className="ctx-item" onClick={() => { restoreSelection(); mediaInsertRangeRef.current = savedSelectionRef.current; gifInputRef.current?.click(); setCtxMenuOpen(false); }}>
                        <span className="ctx-item-left"><span>🎞️</span> Insert GIF</span>
                      </button>
